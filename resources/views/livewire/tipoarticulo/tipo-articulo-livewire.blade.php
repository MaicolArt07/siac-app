                                    ...
                                    @can('funciones-tipoarticulo')
                                        <td class="text-center">
                                            @can('editar-tipoarticulo')
                                                <button class="btn btn-warning btn-sm" wire:click="edit({{ $tipoarticulo->id }})"><i class="fas fa-pencil-alt"></i></button>
                                            @endcan
                                            @can('eliminar-tipoarticulo')
                                                @if ($tipoarticulo->estado == 1)
                                                    <button class="btn btn-danger btn-sm" wire:click="$dispatch('confirmDelete', {{ $tipoarticulo->id }})"><i class="fas fa-trash"></i></button>
                                                @else
                                                    <button class="btn btn-primary btn-sm" wire:click="$dispatch('confirmDelete', {{ $tipoarticulo->id }})"><i class="fas fa-history"></i></button>
                                                @endif
                                            @endcan
                                        </td>
                                    @endcan
