                                ...
                                <tr>
                                    ...
                                    @can('funciones-pais')
                                        <td class="text-center">
                                            @can('editar-pais')
                                                <button class="btn btn-warning btn-sm" wire:click="edit({{ $pais->id }})"><i class="fas fa-pencil-alt"></i></button>
                                            @endcan
                                            @can('eliminar-pais')
                                                @if ($pais->estado == 1)
                                                    <button class="btn btn-danger btn-sm" wire:click="$dispatch('confirmDelete', {{ $pais->id }})"><i class="fas fa-trash"></i></button>
                                                @else
                                                    <button class="btn btn-primary btn-sm" wire:click="$dispatch('confirmDelete', {{ $pais->id }})"><i class="fas fa-history"></i></button>
                                                @endif
                                            @endcan
                                        </td>
                                    @endcan
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title font-italic font-weight-bold">NUEVO PAÍS</h4>
                        ...
                        <form wire:submit="created">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" wire:model="pais.nombre" required>
                                </div>
        ...
        <div class="modal" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: block" aria-modal="true" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Encabezado del Modal -->
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title font-italic font-weight-bold">EDITAR PAÍS</h4>
                        <button type="button" class=" btn btn-danger btn-sm" data-dismiss="modal" wire:click="closeModal">×</button>
                    </div>
