                                ...
                                <tr>
                                    ...
                                    @can('funciones-tipopago')
                                        <td class="text-center">
                                            @can('editar-tipopago')
                                                <button class="btn btn-warning btn-sm" wire:click="edit({{ $tipopago->id }})"><i class="fas fa-pencil-alt"></i></button>
                                            @endcan
                                            @can('eliminar-tipopago')
                                                @if ($tipopago->estado == 1)
                                                    <button class="btn btn-danger btn-sm" wire:click="$dispatch('confirmDelete', {{ $tipopago->id }})"><i class="fas fa-trash"></i></button>
                                                @else
                                                    <button class="btn btn-primary btn-sm" wire:click="$dispatch('confirmDelete', {{ $tipopago->id }})"><i class="fas fa-history"></i></button>
                                                @endif
                                            @endcan
                                        </td>
                                    @endcan
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title font-italic font-weight-bold">NUEVO TIPO PAGO</h4>
                        ...
                        <form wire:submit="created">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" type="text" wire:model="tipopago.nombre" required>
                                </div>
        ...
        <div class="modal" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: block" aria-modal="true" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Encabezado del Modal -->
                    <div class="modal-header bg-primary">
                        <h4 class="modal-title font-italic font-weight-bold">EDITAR TIPO PAGO</h4>
                        <button type="button" class=" btn btn-danger btn-sm" data-dismiss="modal" wire:click="closeModal">×</button>
                    </div>
